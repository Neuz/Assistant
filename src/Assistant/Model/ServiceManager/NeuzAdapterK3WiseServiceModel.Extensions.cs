...
public static class NeuzAdapterK3WiseServiceModelExtensions
{
    /// <summary>
    /// 刷新
    /// </summary>
    ...
    /// <returns></returns>
    public static async Task<NeuzAdapterK3WiseServiceModel> Flush(this NeuzAdapterK3WiseServiceModel model)
    {
        var rs = File.Exists(model.InsConfFilePath)
                     ? await FileUtils.ReadFromConf<NeuzAdapterK3WiseServiceModel>(model.InsConfFilePath) ?? throw new ApplicationException("刷新时序列化失败")
                     : new NeuzAdapterK3WiseServiceModel();
    ...
    /// <returns></returns>
    public static async Task Install(this NeuzAdapterK3WiseServiceModel model, string? zipFilePath, Action<string>? infoAction = null)
    {
    ...
    /// <param name="infoAction"></param>
    /// <returns></returns>
    public static async Task UnInstall(this NeuzAdapterK3WiseServiceModel model, Action<string>? infoAction = null)
    {
        ArgumentNullException.ThrowIfNull(model.ServiceName, nameof(model.ServiceName));
        ArgumentNullException.ThrowIfNull(model.LogDirectory, nameof(model.LogDirectory));
